...
class TestUser_Object_instance(unittest.TestCase):
    ...
    def test_user_firstname_attr(self):
        u1 = User()
        u1.first_name = "Adebayo"
        self.assertEqual(u1.first_name, "Adebayo")

    def test_user_lastname_attr(self):
        u1 = User()
        u1.last_name = "Moses"
        self.assertEqual(u1.last_name, "Moses")
...
class TestUser_Has_attr_basemodel(unittest.TestCase):
    ...
    def test_user_can_take_kwargs(self):
        u2 = User(name="Moses")
        self.assertEqual(u2.name, "Moses")

    def test_user_can_take_multiple_kwargs(self):
        u2 = User(name="Moses", partner="Adebayo")
        self.assertEqual(u2.partner, "Adebayo")
